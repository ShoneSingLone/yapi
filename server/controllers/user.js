...
class userController extends baseController {
  ...
  async getLdapAuth(ctx) {
    try {
      ...
      const emailPostfix = yapi.configs.ldapLogin.emailPostfix;

      const emailParams =
        ldapInfo[yapi.configs.ldapLogin.emailKey || 'mail'] ||
        (emailPostfix ? emailPrefix + emailPostfix : email);
      const username = ldapInfo[yapi.configs.ldapLogin.usernameKey] || emailPrefix;
